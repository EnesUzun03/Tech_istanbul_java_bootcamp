...
public class LoginRegisterController {
    ...
    public void login() {
        int maxAttempts = 3;
        Map<String, Integer> loginAttempts = new HashMap<>();//kullanıcı bilgilerini tutmak için map kullandık
        ...
        while (true) {
            ...
            if (findIsEmail.isPresent()) {
                ...
                //hesap hakkı bitmiş mi onun kontrolu
                if (user.isLocked()) {
                    System.out.println("Hesabınız kilitli.");
                    return;
                }
                //şifre dogrulama işlemi yap
