...
public class TeacherController implements IDaoGenerics<TeacherDto> {
    ...
    @Override
    public StudentDto creat(TeacherDto teacherDto) {
        return TeacherDao.creat(teacherDto);
    }

    @Override
    public StudentDto findbyNama(String name) {
        return TeacherDao.findbyNama(name);
    }
    ...
    public StudentDto update(int id, StudentDto studentDto) {
        return TeacherDao.update(id,studentDto);
    }
