...
public class TeacherDao implements IDaoGenerics<TeacherDto>{
    //private ArrayList<TeacherDto> teacherList =new ArrayList<>();//sadece wrapper türleri destekler
    ...
    @Override
    public TeacherDto creat(TeacherDto teacherDto) {
        return null;
    }

    @Override
    public TeacherDto findbyNama(String name) {
        return null;
    }
